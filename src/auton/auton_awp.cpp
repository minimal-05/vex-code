...
void autonomousAWP() {
  ...
  chassis.turnToPoint(-22.5, -22.5, 800, {.maxSpeed = 60}, false);
  bottomIntake.move(127);
  chassis.moveToPoint(-22.5, -22.5, 2500, {.maxSpeed = 70}, false);
  chassis.turnToPoint(-22.5, 22.5, 800, {.maxSpeed = 60}, false);
  chassis.moveToPoint(-22.5, 10, 1500, {.maxSpeed = 80}, false);
  chassis.moveToPoint(-22.5, 22.5, 1000, {.maxSpeed = 70}, false);
  bottomIntake.move(0);
  
  // score middle top
  chassis.turnToPoint(-13, -13, 800, {.forwards = false, .maxSpeed = 60}, false);
  conveyorPiston.set_value(true);
  chassis.moveToPoint(-13, -13, 800, {.forwards = false, .maxSpeed = 60}, false);
  fullIntake.move(127);
  pros::delay(2000);
  fullIntake.move(0);
  conveyorPiston.set_value(false);
  ...
  //move to other tube
  chassis.moveToPoint(-46, 47, 2000, {.maxSpeed = 80}, false);
  chassis.turnToPoint(-58, 47, 800, {.maxSpeed = 60}, false);
  tonguePiston.set_value(true);
  pros::delay(800);
  bottomIntake.move(127);
  ...
  // move to long goal and score
  chassis.moveToPoint(-30, 47, 10000, {.forwards = false, .maxSpeed = 80}, true);
  pros::delay(2000);
  bottomIntake.move(0);
  fullIntake.move(127);
  pros::delay(5000);
